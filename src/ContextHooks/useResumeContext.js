        ...
        content:[
            {
                ...
                tasks:[
                    "Developed and installed a PHP application that allowed managed wireless access in the Tlamacazapa community center",
                    "Updated and Upgraded the office computer systems",
                    "Taught workers Internet and Computer use safety standards",
                ],
            },
            {
                id:2,
                ...
                tasks:[
                    "Designed a new React Frontend.",
                    "Re-designed their MS-Access Database, and migrated to PostgreSQL.",
                    "Used Spring Boot for Data Security, Persistence & Connectivity.",
                    "Created a PDF Generator to Streamline their report creation process.",
                    "Packaged an Offline version of the WRAP Application, for remote use.",
                ],
            },
            {
                id:3,
